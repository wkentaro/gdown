...
.. testsetup::
    ...
    from pip_api._vendor.packaging.version import parse, normalize_pre, Version, _cmpkey
"""
...
class Version(_BaseVersion):
    ...
    .. versionchanged:: 26.2
        ...
        from pip_api._vendor.packaging < 26.2 is supported but may be removed in a future
        release.
    """
