...
The agent records exactly one of these four mutually exclusive verdicts:
...
`needs-changes` hands the pull request back to its author. The other three verdicts are maintainer-facing.
